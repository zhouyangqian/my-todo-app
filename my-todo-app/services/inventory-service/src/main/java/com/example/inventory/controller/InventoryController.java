...
public class InventoryController {
    ...
    public ApiResponse<Void> batchInbound(
            @Valid @RequestBody BatchInboundRequest request,
            @RequestHeader("X-Tenant-Id") Long tenantId,
            @RequestHeader("X-User-Id") Long userId) {
        for (InboundRequest item : request.getItems()) {
    ...
    public ApiResponse<Void> batchOutbound(
            @Valid @RequestBody BatchOutboundRequest request,
            @RequestHeader("X-Tenant-Id") Long tenantId,
            @RequestHeader("X-User-Id") Long userId) {
        for (OutboundRequest item : request.getItems()) {
