...
public class ErrorDocController {
    ...
    @RequiresPermission(code = "dict:error-doc:list", name = "查询错误分类列表")
    ...
    @RequiresPermission(code = "dict:error-doc:list", name = "查询所有错误分类")
    ...
    @RequiresPermission(code = "dict:error-doc:detail", name = "查询错误分类详情")
    ...
    @RequiresPermission(code = "dict:error-doc:create", name = "创建错误分类")
    ...
    @RequiresPermission(code = "dict:error-doc:update", name = "更新错误分类")
    ...
    @RequiresPermission(code = "dict:error-doc:delete", name = "删除错误分类")
    ...
    @RequiresPermission(code = "dict:error-doc:list", name = "查询解决方案列表")
    ...
    @RequiresPermission(code = "dict:error-doc:detail", name = "查询解决方案详情")
    ...
    @RequiresPermission(code = "dict:error-doc:create", name = "创建解决方案")
    ...
    @RequiresPermission(code = "dict:error-doc:update", name = "更新解决方案")
    ...
    @RequiresPermission(code = "dict:error-doc:delete", name = "删除解决方案")
