    ...
    <el-card class="search-card">
      <el-form :inline="true" :model="searchForm" class="search-form">
        ...
        <el-form-item>
          ...
          <el-button type="success" @click="handleCreate" v-if="userStore.hasPermission('erp:salesOrder:create')">
      ...
      <el-table :data="tableData" v-loading="loading" border stripe>
        ...
        <el-table-column label="操作" fixed="right" width="280">
          <template #default="{ row }">
            ...
            <el-button v-if="row.orderStatus === 0 && userStore.hasPermission('erp:salesOrder:update')" type="warning" link @click="handleEdit(row)">编辑</el-button>
            <el-button v-if="row.orderStatus === 0 && userStore.hasPermission('erp:salesOrder:submit')" type="success" link @click="handleSubmit(row)">提交</el-button>
            <el-button v-if="row.orderStatus === 1 && userStore.hasPermission('erp:salesOrder:approve')" type="success" link @click="handleApprove(row)">审核</el-button>
            <el-button v-if="row.orderStatus < 3 && userStore.hasPermission('erp:salesOrder:cancel')" type="danger" link @click="handleCancel(row)">取消</el-button>
          </template>
        </el-table-column>
      </el-table>
